...
export const experiences: Experience[] = [
  {
    ...
    period: "2025.02 - 至今",
    description: "主导企业级中后台及复杂业务架构设计，沉淀可复用的组件库与技术方案，通过工程化手段提升团队研发效能 30%+。",
    descriptionEn: "Led architecture design for enterprise middle/back-office systems and complex business scenarios, building reusable component libraries and technical solutions that improved team R&D efficiency by 30%+ through engineering practices.",
    tags: ["React", "TypeScript", "Next.js", "架构设计", "工程化"],
    icon: "building",
    current: true,
  },
  {
    ...
    description: "独立负责多端小程序及大规模中后台系统 from 0 to 1 的全链路开发，参与核心业务建模与技术评审，保障项目高质量交付。",
    descriptionEn: "Independently owned end-to-end development of multi-end mini-programs and large-scale middle/back-office systems from 0 to 1, participating in core business modeling and technical reviews to ensure high-quality delivery.",
